...
<html lang="en">
    <head>
        ...
        <!--[if IE 7]>
          <link rel="stylesheet" href="{{ URL::asset('./Admin/css/font-awesome-ie7.min.css') }}" />
        <![endif]-->
        ...
        <link rel="stylesheet" href="{{ URL::asset('./Admin/css/ace.min.css') }}" />
        ...
        <!--[if lte IE 8]>
          <link rel="stylesheet" href="{{ URL::asset('./Admin/css/ace-ie.min.css') }}" />
        <![endif]-->
    ...
    <body>
                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="green">
                            ...
                            <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ URL::asset('./Admin/avatars/avatar.png') }}" class="msg-photo" alt="Alex's Avatar" />
                                        <span class="msg-body">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ URL::asset('./Admin/avatars/avatar3.png') }}" class="msg-photo" alt="Susan's Avatar" />
                                        <span class="msg-body">
                                            <span class="msg-title">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ URL::asset('./Admin/avatars/avatar4.png') }}" class="msg-photo" alt="Bob's Avatar" />
                                        <span class="msg-body">
                                            <span class="msg-title">
                        ...
                        <li class="light-blue">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="{{ URL::asset('./Admin/avatars/user.jpg') }}"  />
                                <!-- <img class="nav-user-photo" src="/Admin/uploads/{{ session('pic') }}" /> -->
                            ...
                            <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                                ...
                                <li>
                                    <a href="#">
                                    <!-- <a href="/admin/adminuser/?id={{session('id')}}/edit"> -->
                                        <i class="icon-user"></i>
                                        个人资料
                                    </a>
                                </li>
                               ...
                               <!--  <li>
                                ...
                                <li>
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li>
                                            <a href="{{ url('/admin/config/create') }}" class="dropdown-toggle">
                                                <i class="icon-pencil"></i>
        ...
        <!--<script src="{{ URL::asset('./Admin/js/jquery-2.0.3.min.js') }}"></script>-->
        <script src="{{ URL::asset('./Admin/js/jquery-2.0.3.min.js') }}"></script>
...
<![endif]-->
        ...
        <script src="{{ URL::asset('./Admin/js/typeahead-bs2.min.js') }}"></script>
        ...
        <script src="{{ URL::asset('./Admin/js/jquery-ui-1.10.3.custom.min.js') }}"></script>
        ...
        <script src="{{ URL::asset('./Admin/js/jquery.easy-pie-chart.min.js') }}"></script>
        <script src="{{ URL::asset('./Admin/js/jquery.sparkline.min.js') }}"></script>
        <script src="{{ URL::asset('./Admin/js/flot/jquery.flot.min.js') }}"></script>
        <script src="{{ URL::asset('./Admin/js/flot/jquery.flot.pie.min.js') }}"></script>
        <script src="{{ URL::asset('./Admin/js/flot/jquery.flot.resize.min.js') }}"></script>
       
        <!-- ace scripts -->
        <script type="text/javascript" src="{{ URL::asset('./Admin/js/jquery-1.8.3.min.js') }}"></script>
